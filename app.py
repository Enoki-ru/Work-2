...
if len(excels)==0:
    print('Не с чем сравнивать')
    print('Производится сохранение первичных данных')
    ...
    name_result_file='Готовый отчет.xlsx'
    save_file(dic['Изменения'],name_result_file)
    change_width(name_result_file)
    ...
    shutil.copyfile(name_main_file,path_read_file)
    print(f"Программа успешно создала отчет. Ознакомиться с результатами можно в файле {name_result_file}")
os.system("pause")